<x-front-layout>
    ...
    <div class="fixed z-50 bottom-6 right-6">
        <a href="https://wa.me/yourphonenumber" target="_blank"
            class="flex items-center px-4 py-3 text-white transition-all duration-300 bg-green-500 rounded-full shadow-lg hover:bg-green-600 group">
            ...
            <span
                class="ml-2 overflow-hidden transition-all duration-500 max-w-0 group-hover:max-w-xs whitespace-nowrap">
