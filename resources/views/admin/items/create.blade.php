                ...
                <form class="w-full" action="{{ route('admin.items.store') }}" method="post"
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Nama type. Contoh: Sport Car, MPV, Bus, dsb. Wajib diisi. Maksimal 255 karakter.
                            </div>
                        </div>
                    </div>
                            ...
                            <select name="type_id" id="type_id"
                                ...
                                @foreach ($variants as $variant)
                                    <option value="{{ $variant->id }}"
                                        {{ old('type_id') == $variant->id ? 'selected' : ' ' }}>
                                        {{ $variant->name }}
                                    </option>
                                @endforeach
                            </select>
                            <div class="mt-2 text-sm text-gray-500">
                                Varian. Contoh: Bensin, Solar, dsb. Wajib diisi.
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <div class="flex flex-wrap px-3 mt-4 mb-6 -mx-3">
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Fitur. Contoh: Fitur 1, Fitur 2, Fitur 3, dsb. Dipisahkan dengan koma. Maksimal 255
                                karakter.
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-3 gap-3 px-3 mt-4 mb-6 -mx-3">
                        ...
                        <div class="w-full">
                            ...
                            <div class="mt-2 text-sm text-gray-500">
                                Review. Berbentuk Angka. Contoh: 5. Opsional.
                            </div>
                        </div>
                    </div>
