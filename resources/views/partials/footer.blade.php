    ...
    <div class="container px-4 mx-auto">
        <div class="flex flex-col items-center justify-between md:flex-row">
            ...
            <div class="flex space-x-6">
                <a href="#" class="text-gray-600 hover:text-red-600" aria-label="Facebook">
                ...
                <a href="https://www.instagram.com/mustikarentalmobil.bks/" class="text-gray-600 hover:text-red-600"
                ...
                <a href="#" class="text-gray-600 hover:text-red-600" aria-label="Twitter">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                        <path
